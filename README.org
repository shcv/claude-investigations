...
Practical techniques derived from experiments, with verified implementation details.

- [[./docs/hook-subagent-detection.org][Hook Subagent Detection]] - Identify whether a hook is firing inside a subagent using transcript matching
- [[./docs/best-practices.org][Best Practices]] - Lessons learned for designing and running experiments
- [[./docs/evaluation-methods.org][Evaluation Methods]] - Approaches for measuring agent behavior
- [[./docs/claude-agent-sdk-porting-guide.org][Agent SDK Porting Guide]] - Migrating between Claude SDK versions
